...
if submit and user_query:
    with st.spinner("Generating answer..."):
        ...
        st.markdown(f"<div style='background-color:#f0f2f6;padding:15px;border-radius:10px'>{ai_reply}</div>", unsafe_allow_html=True)
...
st.markdown("""
    <hr>
    <p style='text-align: center;'>Built with ❤️ by Sakshi Kotur | © 2025</p>
    """, unsafe_allow_html=True)
